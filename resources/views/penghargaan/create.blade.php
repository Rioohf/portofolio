...
<div class="alert alert-danger">{{session('error')}}</div>
    ...
    <div class="mb-3 row">
        ...
        <div class="col-sm-5">
            <input required type="text" class="form-control" name="juara" placeholder="Juara">
        </div>
    </div>
    ...
    <div class="mb-3 row">
        ...
        <div class="col-sm-5">
            <input required type="text" class="form-control" name="perlombaan" placeholder="Perlombaan">
        </div>
    </div>
    ...
    <div class="mb-3 row">
        ...
        <div class="col-sm-5">
            <input required type="number" class="form-control" name="tahun_lomba" placeholder="Tahun Lomba">
        </div>
    </div>
