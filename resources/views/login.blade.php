...
<body class="hold-transition login-page" style="background: linear-gradient(to right, #2980b9, #6dd5fa, #ffffff);">
<div class="login-box">
  <!-- /.login-logo -->
  <div class="card card-outline card-info">
    <div class="card-header text-center">
      <a href="../../index2.html" class="h1"><b>Welcome </b>Portofolio</a>
    </div>
    <div class="card-body">
